...
use Modules\Demo\Http\Logics\EsSampleLogic;
use Modules\Demo\Http\Requests\EsSampleRequest;
use Modules\Demo\Http\Transformers\SampleTrans;
...
class EsSampleController extends BaseController
{
    ...
    public function esSampleIndex(Request $request)
    {
        ...
        $result   = (new ApiCache)->collect($hKey, $queryKey, function () use ($requestQuery) {
            ...
            //输出逻辑控制
            return ApiTrans::itemPageList($result, SampleTrans::class, 'transform');
