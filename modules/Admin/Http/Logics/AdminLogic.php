...
use Modules\Admin\Repositories\AdminRepo;
 ...
 */
class AdminLogic extends BaseService
{
    ...
    public function adminLogin($mobile, &$requestInput)
    {
        ...
        if ($builder->pass_word != $pw) {
            Exception::http(AdminRootError::code("PASS_WORD_WRONG"), AdminRootError::msg("PASS_WORD_WRONG"), __METHOD__);
        }
    ...
    public function adminMeDetail(array $requestQuery, $adminId)
    {
        //业务逻辑
        //{@field_detail
        $fields = ["id", "user_id", "role", "name", "avatar", "sex", "mobile", "pass_word", "client_driver", "client_type",
     ...
     * 系统-获取-管理员列表
     */
    public function adminSysCollect(array $requestQuery)
    {
        //业务逻辑
