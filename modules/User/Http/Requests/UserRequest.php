...
class UserRequest extends BaseRequest
{
    ...
    protected $rules = [
        ...
        "nick_name"     => "string|between:0,255",
    ...
    protected $messages = [
        ...
        'role.string'     => '用户角色 包含非法字符-只能是字符串',
        'role.alpha'      => '用户角色 包含非法字符-只能是/字母',
        'role.alpha_num'  => '用户角色 包含非法字符-只能是/字母/数字',
        'role.alpha_dash' => '用户角色 包含非法字符',
        'role.between'    => '用户角色 最大长度是 255',

        'name.string'     => '用户姓名 包含非法字符-只能是字符串',
        'name.alpha'      => '用户姓名 包含非法字符-只能是/字母',
        'name.alpha_num'  => '用户姓名 包含非法字符-只能是/字母/数字',
        'name.alpha_dash' => '用户姓名 包含非法字符',
        'name.between'    => '用户姓名 最大长度是 255',

        'nick_name.string'     => '用户昵称 包含非法字符-只能是字符串',
        'nick_name.alpha'      => '用户昵称 包含非法字符-只能是/字母',
        'nick_name.alpha_num'  => '用户昵称 包含非法字符-只能是/字母/数字',
        'nick_name.alpha_dash' => '用户昵称 包含非法字符',
        'nick_name.between'    => '用户昵称 最大长度是 255',

        'avatar.string'     => '用户头像 包含非法字符-只能是字符串',
        'avatar.alpha'      => '用户头像 包含非法字符-只能是/字母',
        'avatar.alpha_num'  => '用户头像 包含非法字符-只能是/字母/数字',
        'avatar.alpha_dash' => '用户头像 包含非法字符',
        'avatar.between'    => '用户头像 最大长度是 255',
    ...
    {
        return $this
            ->append('nick_name', 'required')
            ->append('mobile', 'required')
            ->append('pass_word', 'required')
            ->append('client_driver', 'required')
            ->append('client_type', 'required')
            ->append('lat', 'required')
            ->append('lng', 'required');
    }
    ...
    {
        return $this
            ->append('scope_id', 'required')
            ->append('client_id', 'required')
            ->append('mobile', 'required')
            ->append('pass_word', 'required')
            ->append('client_driver', 'required')
            ->append('client_type', 'required')
