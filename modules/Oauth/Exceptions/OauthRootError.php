...
class OauthRootError
{
    ...
    protected static $data = [
        ...
        //自定义
        //# OauthClient 数据单元 使用
        "OAUTH_CLIENT_ID_NOT_FOUND" => ['code' => 200010, 'msg' => '授权客户端ID 不存在'],
        //# OauthRole 数据单元 使用
        "ROLE_ID_NOT_FOUND"         => ['code' => 200020, 'msg' => '角色ID 不存在'],
        "ROLE_ID_NOT_UNIQUE"        => ['code' => 200021, 'msg' => '角色ID 已存在'],
        //# OauthToken 数据单元 使用
