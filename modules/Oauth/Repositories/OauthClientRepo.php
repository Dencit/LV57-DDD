...
use Modules\Oauth\Models\OauthClientModel;
...
class OauthClientRepo extends BaseRepository
{
    ...
    public function queryMatchCollect(QueryMatch $QM)
    {
        ...
        $QM->incModelHaveClosure(
            OauthClientModel::class, $includeArr, function ($include) use (&$query) {
            $query->with($include);
        }
        );
    ...
    //检查授权客户端标识是否存在
    public static function isOauthClientExit($scopeId, $clientId)
    {
